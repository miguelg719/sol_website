...
const images = [
    { src: `./images/paintings/ring.png`, alt: "Green ring pop", span: "col-span-1 row-span-1", bgColor: "bg-gray-100", title: "Chuches 1", description: "Acrílico sobre lienzo, 2024", dimensions:" 50x60 cm" },
