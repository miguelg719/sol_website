...
const images = [
  { src: '/images/collages/collage_1.png', alt: "Fruit arrangement", span: "col-span-1 row-span-1", bgColor: "bg-gray-100", title: "Tabachines", description: "Digital collage, 2024" , dimensions: "8.5 x 11 in" },
